...
#Feito
@ArvCentral  @ConsultaCnpjMaisUmEc
...
@ArvCentral  @SimularArvUmEc
  ...
  #Feito
  @ArvCentral @ContratacaoArvParcial
 ...
 @ArvCentral  @ContratacaoArvRecorrente
