...
Funcionalidade: Contratacao ARV pela Central
  ...
  @Release-15 @front @Regressivo @saudacao @robo
  Esquema do Cenario: <VSTS> - Validar Saudacao de <cenario>
  ...
  Esquema do Cenario: <VSTS> - Validar Botão sair
    Dado que eu acesse o portal ARV na central
    E insira o CPF "55356357079" com acesso
    E insira a senha "12345678aA@" válida
  ...
  Esquema do Cenario: <VSTS> - Consulta de CNPJ <cenario> ARV disponível
    Dado que eu esteja logado no portal ARV na central com CPF "55356357079" e senha "12345678aA@"
    E inserir um CNPJ <cenario> ARV disponível "<cnpj>"
  ...
  Esquema do Cenario: <VSTS> - Consultar CNPJ Não existente
    Dado que eu esteja logado no portal ARV na central com CPF "55356357079" e senha "12345678aA@"
  ...
  Esquema do Cenario: <VSTS> - <Cenario> - <DescricaoDoCenario>
    Dado que eu esteja logado no portal ARV na central com CPF "55356357079" e senha "12345678aA@"
    ...
    Exemplos: 
      | VSTS | Cenario | DescricaoDoCenario                          | ec1        | ec2        |
  ...
  Esquema do Cenario: <VSTS> - <Cenario> - <DescricaoDoCenario>
    Dado que eu esteja logado no portal ARV na central com CPF "55356357079" e senha "12345678aA@"
    E que inserir um CNPJ com mais de um EC com ARV disponível para contratacao "<cnpj>"
    ...
    Exemplos: 
      | VSTS | Cenario | DescricaoDoCenario                                 | cnpj           |
  ...
  Esquema do Cenario: <VSTS> - <Cenario> - <DescricaoDoCenario>
    ...
    Exemplos: 
      | VSTS | Cenario | DescricaoDoCenario                                | cnpj           | valor |
  ...
  Esquema do Cenario: <VSTS> - <Cenario> - <DescricaoDoCenario>
    ...
    Exemplos: 
      | VSTS | Cenario | DescricaoDoCenario            | cnpj           | confirmacao | recorrencia |
      |      | CT01.1  | Contratar recorrencia Diaria  | 28339982000160 | diaria      | diaria      |
      |      | CT01.2  | Contratar recorrencia Semanal | 28339982000160 | segunda     | semanal     |
