...
Funcionalidade: Painel
  ...
  Esquema do Cenario: <VSTS> - Upload de planilha <cenario>
    ...
    Exemplos: 
      ...
      | 9999 | Desbloquear CNPJ que não tenha contrato ativo                                                                         | 546.219.170-72 | Alelo2018@ | EL             | /src/test/resources/armazenador/bloqueioPainel/ | Desloqueio sem contrato ativo.xlsx                           | select * from owadq.tacs_contr_indcd WHERE nu_cnpj = |    3 |
