...
Funcionalidade: Recebimentos
  ...
  Esquema do Cenario: <VSTS> - Comprovante detalhado <cenario>
    ...
    Exemplos:
      | VSTS    | cenario                                                                                                     | cnpj           | produto           | comprovante |
      | 9999-10 | Consultar detalhe das transações de acordo com o produto e realizar o download do comprovante - REFEIÇÃO    | 28339982000160 | ALELO REFEICAO    | true        |
      | 9999-11 | Consultar detalhe das transações de acordo com o produto e realizar o download do comprovante - ALIMENTAÇÃO | 28339982000160 | ALELO ALIMENTACAO | true        |
      | 9999-12 | Consultar detalhe das transações de acordo com o produto e realizar o download do comprovante - TODOS       | 28339982000160 | TODOS             | true        |
