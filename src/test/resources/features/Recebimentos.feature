...
Funcionalidade: Recebimentos
  ...
  Esquema do Cenario: <VSTS> - Recebimento detalhado <cenario>
    ...
    Exemplos: 
      ...
      | 9999 | Consultar Recebimentos por tipo de produto - REFEIÇÃO    | REFEIÇÃO    | 28339982000160 |
      #| 9999 | Consultar Recebimentos por tipo de produto - ALIMENTAÇÃO | ALIMENTAÇÃO | 28339982000160 |
